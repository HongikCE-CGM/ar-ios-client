...
public class FeedUIButtonCreator : MonoBehaviour
{
    ...
    void CreateModernButton()
    {
        ...
        toggleButtonImage.color = new Color(0.9f, 0.5f, 0.2f, 0.8f); // 모던한 오렌지
        ...
        modernAnimator.SetColors(
            new Color(0.9f, 0.5f, 0.2f, 0.8f), // normal
            new Color(1.0f, 0.6f, 0.3f, 0.9f), // hover
            new Color(0.7f, 0.3f, 0.1f, 1.0f)  // press
        );
    }
    ...
    void UpdateButtonAppearance()
    {
        if (feedOn)
        {
            var activeColor = new Color(0.7f, 0.3f, 0.1f, 1f); // 더 진한 오렌지
            ...
            if (modernAnimator != null)
            {
                modernAnimator.SetColors(
                    activeColor,
                    new Color(0.8f, 0.4f, 0.2f, 1f), // hover
                    new Color(0.6f, 0.2f, 0.05f, 1f) // press
                );
            }
        }
        else
        {
            var normalColor = new Color(0.9f, 0.5f, 0.2f, 0.8f); // 원래 오렌지
